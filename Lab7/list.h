...
void list_add_by_policy(list_t *l, block_t  *newblk, int policy);
...
node_t *list_remove_node(node_t *head, node_t *node);

/* Checks to see if block of Size exists in the list. */
bool list_is_in(list_t *l, block_t  *newblk);
...
int list_get_index_of(list_t *l, block_t *newblk);
